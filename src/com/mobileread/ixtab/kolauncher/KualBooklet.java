...
//import com.mobileread.ixtab.kolauncher.resources.KualEntry;
import com.mobileread.ixtab.kolauncher.resources.KualLog;
/*import com.mobileread.ixtab.kolauncher.resources.KualMenu;
import com.mobileread.ixtab.kolauncher.resources.MailboxCommand;
import com.mobileread.ixtab.kolauncher.resources.MailboxProcessor;
import com.mobileread.ixtab.kolauncher.resources.ResourceLoader;
import com.mobileread.ixtab.kolauncher.timer.TimerAdapter;
import com.mobileread.ixtab.kolauncher.ui.GapComponent;
import com.mobileread.ixtab.kolauncher.ui.UIAdapter;
*/
public class KualBooklet extends AbstractBooklet implements ActionListener {
	...
	private static final String EXEC_PREFIX_PARSE = "kolauncher_parse-";
	private static final String EXEC_PREFIX_BACKGROUND = "kolauncher_background-";
...
*/
	...
	public void actionPerformed(ActionEvent e) {
		new KualLog().append("Action Performed");
	}
/*
...
*/
	private Process execute()
		...
		String dir = "/mnt/us/koreader/";
		File workingDir = new File(dir);
		if (!workingDir.isDirectory()) {
			new KualLog().append("directory '" + dir + "' not found");
			return null;
		}
		File launcher = createLauncherScript();
		// Check current privileges...
		String currentUsername = System.getProperty("user.name");
		if ("root".equals(currentUsername)) {
			PRIVILEGE_HINT_PREFIX = "#";
	...
	private File createLauncherScript() throws IOException {
		...
		// redirecting stderr
		bw.write("{ /mnt/us/koreader/koreader.sh --kual  ; } 2>>/var/tmp/KOL.log &");
